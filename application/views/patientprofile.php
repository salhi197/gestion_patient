                        ...
                        <div class="page-title-box">
                            <div class="btn-group pull-right">
                                <ol class="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li class="breadcrumb-item active">Profile de Patient </li>
                                </ol>
                            </div>
                            <h4 class="page-title">Profile de Patient </h4>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card m-b-20">
                            <div class="card-block">
                                ...
                                <div class="user-btm-box">
                                    ...
                                    <a href="<?php echo base_url('user/editpatient')."/".$id;?>"><button type="button" class="btn btn-primary waves-effect waves-light"><i class="fa fa-pencil"></i>&nbsp; Modifier</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card m-b-20">
                            <div class="card-block">
                                ...
                                <ul class="nav nav-tabs nav-tabs-custom mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#medical" role="tab" aria-expanded="false">Infos.Medical </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#appointment" role="tab" aria-expanded="false">List des RDVs </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#prescription" role="tab" aria-expanded="false">Listes Des Ordonnances</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#billing" role="tab" aria-expanded="true">Facture</a>
                                    </li>
                                </ul>
                                <!-- Tab panes -->
                                        ...
                                        <table class="table table-bordered datatable-init">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button type="button" class="btn btn-1d btn-sm btn-outline-primary waves-effect waves-light">Visité</button></td>
                                                    <td><a href="#"><button type="button" class="btn btn-1d btn-sm btn-outline-primary waves-effect waves-light">Voir Ordonnance</button></td>
                                                </tr>
                                                    <?php
                                                        $i++;
                                                        endforeach; ?>
                                        ...
                                        <table class="table table-bordered  datatable-init">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url('user/print_prescription')."/".$preinfo['prescription_id'];?>"><button type="button" class="btn btn-1d btn-sm btn-outline-primary waves-effect waves-light">Imprimer Ordonnance</button></td>
                                                </tr>
                                                        <?php 
                                                            $i++;
                                                        endforeach; ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $invoiceinfo['invoice_id'];?>"><button type="button" class="btn btn-1d btn-sm btn-outline-primary waves-effect waves-light">Imprimer Facture</button></a>
                                                    </td>
                                                </tr>
                                                    <?php 
                                                        $i++;
