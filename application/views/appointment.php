                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title mt-0" id="myLargeModalLabel">Ajouter un Rendez-vous</h5>
                                    ...
                                    <div class="modal-body">
                                        <div>
                                            ...
                                            <form class="p-3" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <blockquote><lable class="status">Pas de Programme Aujourd'hui</lable></blockquote>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                            ...
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-md-12 m-b-20">
                                        <h5>List des Rendez-vous | <lable id="selected_date"><?php echo date('d M, Y'); ?></lable></h5>
                                    </div>
                                </div>
                                <div class="row">
