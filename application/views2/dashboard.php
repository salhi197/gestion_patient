            ...
            <div class="container">
                ...
                <div class="row"> 
                    <div class="col-lg-8">
                        <div class="card m-b-20">
                            <div class="card-block">
                                <h4 class="mt-0 header-title">RDVs M</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="card m-b-20">
                            <div class="card-block">
                                <h4 class="mt-0 header-title">Analyse des Factrues</h4>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card m-b-20">
                            <div class="card-block">
                                <h4 class="mt-0 m-b-30 header-title">Derniérs Patients</h4>
                                    ...
                                    <table class="table table-vertical">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url('user/patient_profile')."/".$data['patient_id'];?>"><button type="button" class="btn btn-1d btn-sm btn-outline-primary waves-effect waves-light">Gérer Patient</button>
                                                </td>
                                            </tr>
