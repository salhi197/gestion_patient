                    ...
                    <div class="p-3">
                        ...
                        <form class="form-horizontal m-t-30" method="post" action="<?php echo base_url('user_operation/setup'); ?>" enctype="multipart/form-data">
                        	...
                        	<div class="row">
                        		<div class="col-md-12">
                        			<div class="form-group">
		                                <label for="title">Titre de System </label>
                            ...
                            <div class="form-group row">
                                <label class="col-3 col-form-label">Logo de System </label>
                                <div class="col-9">
                            ...
                            <div class="form-group row">
                                <label class="col-3 col-form-label">Icon de System </label>
                                <div class="col-9">
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                            ...
                            <div class="form-group row m-t-20">
                                <div class="col-sm-12 text-right">
                                    <button class="btn btn-primary w-md waves-effect waves-light" type="submit">Install</button>
                                </div>
                            </div>
                        </form>
                    </div>
